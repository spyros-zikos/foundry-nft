...
.PHONY: all test clean deploy help install snapshot format anvil mint deployMood mintMoodNft flipMoodNft
...
# Change interactions script with deployed contract address
mintMoodNft:
	@forge script script/Interactions.s.sol:MintMoodNft $(NETWORK_ARGS)

# Change interactions script with deployed contract address and tokenId
flipMoodNft:
